jQuery(document).ready(function ($) {
    //Disable Enter keypress for keyword input field
    $('#wtt-keyword').keypress(function (e) {
            ...
            controller: ["$scope", "$attrs", "$element", function ($scope, $attrs, $element) {
                ...
                $scope.tryAdd = function () {
                    ...
                    if (tag.length >= $scope.options.minLength && $scope.options.allowedTagsPattern.test(tag)) {
                        ...
                        if (tag && maxTags && $scope.tags.length > maxTags) {
...
angular.module('ui.bootstrap.progressbar', ['ui.bootstrap.transition'])
    ...
    .directive('bar', function () {
        return {
            ...
            template: "<div class=\"bar\" ng-class=\"type && 'bar-' + type\" ng-transclude></div>",
    ...
    .directive('progressbar', function () {
        return {
            ...
            template: "<div class=\"progress\"><div class=\"bar\" ng-class=\"type && 'bar-' + type\" ng-transclude></div></div>",
            link: function (scope, element, attrs, progressCtrl) {
